...
def run_generation_pipeline(
    ...
    # Do not globally kill ffmpeg processes here. MoviePy/FFmpeg resources are
    # closed above by the owning clip objects, and killing by process name can
    # terminate unrelated renders when multiple jobs or users are active.
