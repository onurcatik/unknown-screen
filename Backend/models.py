...
class VideoProject(Base):
    ...
    platform: Mapped[str] = mapped_column(String(80), nullable=False, default="youtube_shorts")
    target_duration: Mapped[int] = mapped_column(Integer, nullable=False, default=40)
    voice_style: Mapped[str] = mapped_column(String(120), nullable=True)
    caption_style: Mapped[str] = mapped_column(String(120), nullable=True)
    status: Mapped[str] = mapped_column(String(40), nullable=False, default="planned", index=True)
    timeline_json: Mapped[dict] = mapped_column(JSON, nullable=True)
